...
from robot_pendula import InvertedPendulum, InvertedPendulumSwingup, InvertedDoublePendulum, InvertedDoublePendulumSwingup
...
class InvertedDoublePendulumSwingupBulletEnv(InvertedDoublePendulumBulletEnv):

  def __init__(self):
    self.robot = InvertedDoublePendulumSwingup()
    MJCFBaseBulletEnv.__init__(self, self.robot)
    self.stateId = -1
